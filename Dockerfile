...
WORKDIR /MediaCrawler

# 设置/MoneyPrinterTurbo目录权限为777
RUN chmod 777 /MediaCrawler

ENV PYTHONPATH="/MediaCrawler"
...
CMD ["streamlit", "run", "./web/api_server.py","--server.enableCORS=True","--browser.gatherUsageStats=False"]
